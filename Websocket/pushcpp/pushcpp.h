...
public:
	...
	typedef std::function<void(const ConnectionEvent)> ConnectionEventHandler;
	typedef std::function<void(const int, const std::string)> ErrorEventHandler;
	typedef std::function<void(const std::string&, const std::string&, const std::string&)> ChannelEventHandler;
	typedef std::function<void(const std::string&)> ChannelPresenceHandler;
	...
	struct ChannelData {
		...
		std::vector<ChannelEventHandler> eventHandlers;
