...
#define _IRSTD_LOG1(message) __IRSTD_LOG(IrStd::Logger::getDefault(), IrStd::Logger::Level::Info, None, message)
#define _IRSTD_LOG2(level, message) __IRSTD_LOG(IrStd::Logger::getDefault(), level, None, message)
...
#define _IRSTD_LOG_X2(logger, message) __IRSTD_LOG(logger, IrStd::Logger::Level::Info, None, message)
#define _IRSTD_LOG_X3(logger, level, message) __IRSTD_LOG(logger, level, None, message)
